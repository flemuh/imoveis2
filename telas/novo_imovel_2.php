...
?>
    ...
    if ((isset($_POST["executar"])) && (!empty($_FILES['foto']))) {
    ...
    <div class="col-7 col-xs-7 col-sm-7 col-md-7 col-lg-7">
        ...
        <form name="cadastraimovel-2" id="cadastraimovel-2" method="post" action="novo_imovel_3.php"
            ...
            <table>
                ...
                <tr>
                    <td>
                        <select name="imovelrua">
                            ...
                            <option value="at">Alfredo Tuffóli</option>
                ...
                <tr>
                    <td>
                        <select name="imovelbairro">
                            ...
                            <option value="st">Santo António</option>
                ...
                <tr>
                    <input class="btn" type="submit" name="executar" id="executar" value="Próximo Passo"/>
                    <td>
